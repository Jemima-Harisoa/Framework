...
TEST_DIR="$(dirname "$ROOT")/Test"    # prise en charge Test/ (majuscule)
if [ ! -d "$TEST_DIR" ]; then TEST_DIR="$(dirname "$ROOT")/test"; fi
...
# --- 3) copier vers Test/src/main/webapp/WEB-INF/lib ---
